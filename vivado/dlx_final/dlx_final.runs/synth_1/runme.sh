...
HD_PWD='C:/Users/Nicole/Desktop/Vivado/dlx_final/dlx_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dlx_syn.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dlx_syn.tcl
