...
% pc_sel nel caso di jump è sempre a 1 -> corrisponde ad un branch always taken

% 1 caso: l'offset è l'immediato passato dal id e viene usato dall'adder secondario
% 2 caso: l'id passa il registro contenente il valore del nuovo pc, questo viene mandato fuori in npc_jr

% jr: il registro destinazione passa nella alu, viene mandato fuori tramite npc_jr
% jalr: il registro destinazione passa nella alu, viene mandato fuori tramite npc_jr, il valore di pc+4 passa in op_b

% jal: il valore di pc+4 passa in op_b